            ...
            <style dangerouslySetInnerHTML={{
                ...
                .green-sweep {
                    background: conic-gradient(
                        ...
                        rgba(52, 211, 153, 0.4) 70%,
                        rgba(16, 185, 129, 0.7) 75%,
                        rgba(5, 150, 105, 1) 80%,
                        rgba(16, 185, 129, 0.8) 85%,
                        rgba(52, 211, 153, 0.5) 90%,
                        rgba(34, 197, 94, 0.3) 95%,
                        transparent 100%
                    );
                }
                ...
                .green-wave {
                    background: conic-gradient(
                        ...
                        transparent 0%,
                        transparent 55%,
                        rgba(22, 163, 74, 0.3) 62%,
                        rgba(34, 197, 94, 0.5) 68%,
                        rgba(16, 185, 129, 0.7) 75%,
                        rgba(52, 211, 153, 0.6) 82%,
                        rgba(34, 197, 94, 0.4) 88%,
                        transparent 95%,
                        transparent 100%
                    );
                }
