    ...
    return (
        <>
            <style dangerouslySetInnerHTML={{
                ...
                .green-bg {
                    background: linear-gradient(135deg, #064e3b, #047857, #059669, #065f46);
                    box-shadow: 0 0 20px rgba(6, 95, 70, 0.5), inset 0 0 10px rgba(6, 78, 59, 0.3);
                }
                
                .blue-bg {
                    background: linear-gradient(135deg, #1e3a8a, #1e40af, #2563eb, #1d4ed8);
                    box-shadow: 0 0 20px rgba(30, 58, 138, 0.5), inset 0 0 10px rgba(23, 37, 84, 0.3);
                }
                
                .orange-bg {
                    background: linear-gradient(135deg, #9a3412, #c2410c, #ea580c, #b45309);
                    box-shadow: 0 0 20px rgba(154, 52, 18, 0.5), inset 0 0 10px rgba(124, 45, 18, 0.3);
                }
                
                .purple-bg {
                    background: linear-gradient(135deg, #581c87, #6d28d9, #7c3aed, #6b21a8);
                    box-shadow: 0 0 20px rgba(88, 28, 135, 0.5), inset 0 0 10px rgba(55, 16, 107, 0.3);
                }
