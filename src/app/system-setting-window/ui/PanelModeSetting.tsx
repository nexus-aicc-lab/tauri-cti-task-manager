...
//                     {/* 🆕 두 번째, 세 번째 박스 - 고정 너비로 독립성 확보 */}
//                     <div className="flex flex-col gap-3" style={{ width: '500px', minWidth: '500px' }}>
//                         {/* 두 번째 박스 - 영역 선택 */}
//                         <div className="bg-white rounded-lg shadow-md p-3" style={{ height: '280px' }}>
//                             <h3 className="text-md font-bold text-gray-800 mb-2 text-center">영역 선택</h3>
//                             <div className="space-y-2 h-full overflow-y-auto pb-8">
//                                 {[
...
//                             ) : (
//                                 <>
//                                     <div className="grid grid-cols-2 gap-2 h-full overflow-y-auto pb-8">
